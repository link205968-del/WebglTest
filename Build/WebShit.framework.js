...
var ASM_CONSTS = {
  3744128: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 3744189: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 3744253: function() {return Module.webglContextAttributes.powerPreference;},  
 3744311: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 3744366: function($0) {performance.now = function() { return $0; };},  
 3744414: function($0) {performance.now = function() { return $0; };},  
 3744462: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  */
  ...
  function _Photon_JS_TimerWorker_Start(callback, interval) {
          ...
          worker.onmessage = () => { (function(a1) {  dynCall_vi.apply(null, [callback, a1]); })(handle); }
